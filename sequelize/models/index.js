...
const modelProyectoXTecnologia = require("../models/proyectoxtecnologia")
...
db[modelProyectoXTecnologia(sequelize, Sequelize.DataTypes).name] = modelProyectoXTecnologia(sequelize, Sequelize.DataTypes);
